...
anova_test <- function(df, continuous_var, categorical_var) {
  aov(df[[continuous_var]] ~ df[[categorical_var]], data = df)
}

# ANOVA Tests
anova_results <- list(
  "Carapace Width vs Tidal Zone" = summary(anova_test(data, "carapace_width", "tidal_zone")),
  "Carapace Width vs Sex" = summary(anova_test(data, "carapace_width", "sex"))
)
...
# ANOVA for Carapace Width vs Sex
anova_sex <- aov(carapace_width ~ sex, data = data)
summary(anova_sex)

# ANOVA for Carapace Width vs Tidal Zone
anova_tidal_zone <- aov(carapace_width ~ tidal_zone, data = data)
summary(anova_tidal_zone)
```

```{r}

  posthoc_sex <- TukeyHSD(anova_sex)
  print(posthoc_sex)

  posthoc_tidal_zone <- TukeyHSD(anova_tidal_zone)
  print(posthoc_tidal_zone)
