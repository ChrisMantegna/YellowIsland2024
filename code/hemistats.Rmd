...
# Read-in the data
data <- read.csv("/Users/cmantegna/Documents/GitHub/YellowIsland2024/data/hemi_complete.csv")
```
...
# New carapace plot - leg hair
```{r}

carapace<- ggplot() +
  geom_histogram(data = crabs_with_leg_hair, aes(x = carapace_width, fill = "Purple"), binwidth = 1, alpha = 0.5) +
  geom_histogram(data = crabs_without_leg_hair, aes(x = carapace_width, fill = "Yellow"), binwidth = 1, alpha = 0.5) +
  labs(title = "Carapace Width Distribution", x = "Carapace Width", y = "Frequency") +
  scale_fill_manual(
    name = "Crab",
    values = c("Purple" = "darkorchid4", "Yellow" = "gold2", "Unidentified" = "darkgrey")
  ) +
  theme_minimal(base_size = 15) + # Increases the base size for text
  theme(
...
ggsave(filename= "/Users/cmantegna/Documents/GitHub/YellowIsland2024/output/carapace_leghair.png", plot=carapace, width = 12, height = 10, dpi = 300)
...
ggplot() +
  ...
  labs(title = "Carapace Width Distribution", x = "Carapace Width", y = "Frequency") +
  scale_fill_manual(name = "Crab", values = c("With Leg Hair" = "darkorchid4", "Without Leg Hair" = "gold2")) +
  theme_minimal()
...
ggplot(tidal_zone_counts, aes(x = tidal_zone, y = n, fill = leg_hair)) +
  ...
  scale_fill_manual(
    name = "Crab",
    values = c("N" = "darkorchid4", "Y" = "gold2", "Unidentified" = "darkgrey"),
    labels = c("N" = "Purple", "Y" = "Yellow", "Unidentified" = "Unidentified")
  ) +
...
ggplot(tidal_zone_counts, aes(x = tidal_zone, y = n, fill = spotted_claws)) +
  ...
  scale_fill_manual(
    name = "Crab",
    values = c("Y" = "darkorchid4", "N" = "gold2", "Unidentified" = "darkgrey"),
    labels = c("Y" = "Purple", "N" = "Yellow", "Unidentified" = "Unidentified")
  ) +
  theme_minimal(base_size = 15) +
  theme(
    panel.background = element_rect(fill = "white", color = NA), # White background for plot area
...
claws<- ggplot(data, aes(x = carapace_width, fill = spotted_claws)) +
...
ggsave(filename= "/Users/cmantegna/Documents/GitHub/YellowIsland2024/output/carapace_claws.png", plot=claws, width = 12, height = 10, dpi = 300)
...
# Define the new data
sizes <- c(174, 90, 43)  # Updated counts for combined categories
labels <- c('Unidentified', 'Yellow', 'Purple')  # Renamed categories
colors <- c('darkgrey', '#CDAD00', '#68228B')  # Updated colors: black, gold, purple
...
ggplot(pie_data, aes(x = "", y = percentage, fill = category)) +
  ...
  theme_void() +
  labs(title = "Identification of Species By Both Characteristics") +
  theme(
